          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex justify-center mt-4">
              <Link to="/shop" className="group flex flex-col items-center gap-3 rounded-3xl border-2 border-armenian-red/20 bg-armenian-cream px-10 py-6 shadow-soft transition-all hover:border-armenian-red hover:shadow-pop">
                ...
                <span className="font-display text-lg font-black text-armenian-red">See All Books &rarr;</span>
              </Link>
            </div>
          </div>
        </div>
      ...
      <section className="bg-armenian-apricot/15">
        <div className="container-page section">
          <div className="flex items-end justify-between gap-4">
            ...
            <Link to="/learn-alphabet" className="hidden text-sm font-bold text-armenian-blue hover:underline sm:inline">
          ...
          <div className="grid gap-6 p-10 sm:grid-cols-[1fr,auto] sm:items-center sm:p-14">
            <div>
              ...
              <p className="mt-3 max-w-xl text-armenian-cream/85">
                We'd love to chat. Send us a note and we'll get back to you within a few days.
              </p>
            </div>
            <Link to="/contact" className="btn justify-self-start bg-armenian-cream text-armenian-ink hover:bg-white sm:justify-self-end">
              Contact us
            </Link>
          </div>
        </div>
